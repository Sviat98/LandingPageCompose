...
import com.bashkevich.landingpage.components.Header
import com.bashkevich.landingpage.components.SocialBar
import com.bashkevich.landingpage.models.Section
import com.bashkevich.landingpage.models.Theme
import com.bashkevich.landingpage.styles.MainButtonStyle
import com.bashkevich.landingpage.styles.MainImageStyle
import com.bashkevich.landingpage.util.Constants.FONT_FAMILY
import com.bashkevich.landingpage.util.Constants.LOREM_IPSUM_SHORTEST
...
fun MainText(breakpoint: Breakpoint) {
    Row(
        ...
        Column {
            ...
            P(
                attrs = Modifier.margin(top = 10.px, bottom = 5.px).fontFamily(FONT_FAMILY).fontSize(20.px)
                    .fontWeight(FontWeight.Bold).color(Theme.Secondary.rgb).toAttrs()
            ) {
                Text("Mobile & Web Developer/Designer")
            }
            P(
                attrs = Modifier.margin(bottom = 25.px).maxWidth(400.px).fontFamily(FONT_FAMILY).fontSize(15.px)
                    .fontStyle(FontStyle.Italic).fontWeight(FontWeight.Normal).color(Theme.Secondary.rgb).toAttrs()
            ) {
                Text(LOREM_IPSUM_SHORTEST)
            }
            Button(
                attrs = MainButtonStyle.toModifier().height(40.px)
                    .border(width = 0.px)
                    .borderRadius(5.px)
