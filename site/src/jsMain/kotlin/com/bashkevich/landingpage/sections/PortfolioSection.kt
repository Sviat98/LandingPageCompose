...
import com.bashkevich.landingpage.components.PortfolioCard
import com.bashkevich.landingpage.components.SectionTitle
import com.bashkevich.landingpage.models.Portfolio
import com.bashkevich.landingpage.models.Section
import com.bashkevich.landingpage.styles.PortfolioArrowIconStyle
...
fun PortfolioSection() {
    ...
    Box(
        modifier = Modifier.id(Section.Portfolio.id)
            .maxWidth(Constants.SECTION_WIDTH.px).padding(topBottom = 100.px),
...
fun PortfolioCards(
    ...
    Row(
        ...
        Portfolio.values().forEach { portfolio ->
            PortfolioCard(
                modifier = Modifier.margin(right = if (portfolio == Portfolio.Five) 0.px else 25.px),
                portfolio = portfolio
            )
        }
    }
