...
fun SectionTitle(
    ...
    Column(
        ...
        P(
            attrs = Modifier.fillMaxWidth().textAlign(
        ...
        P(
            attrs = Modifier.fillMaxWidth().textAlign(
                ...
                .fontFamily(FONT_FAMILY).fontSize(40.px)
        ...
        Box(
            modifier = Modifier.height(2.px).width(80.px).backgroundColor(Theme.Primary.rgb).borderRadius(50.px)
        ) {
